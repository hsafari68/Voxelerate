...
A top-level `models/` folder is included for local reference meshes and examples. It now contains the curated demo set used throughout the repository: `Eiffel_Tower.stl`, `David.stl`, `C12.STL`, and `2,5 mm cut.STL`.
