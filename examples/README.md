...
- `01_single_mesh_pipeline.py` — load `models/David.stl`, build a solid voxel grid, construct a BVH and mesh octree, visualize the mesh / voxel grid / hierarchies, save the voxel grid, reload it, and inspect central slices with a voxel-octree overlay.
